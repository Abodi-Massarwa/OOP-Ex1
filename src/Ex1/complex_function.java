...
public interface complex_function extends function{
	 ...
	 * 
	 * @param f1 the complex_function which will be divided this complex_function.
	 */
	...
	/** returns the right side of the complex function - this side might not exist (a.k.a equals null).
	 * @return a function representing the left side of this complex function
	 */
