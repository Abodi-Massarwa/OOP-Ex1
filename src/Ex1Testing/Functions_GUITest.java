...
class Functions_GUITest {
	...
	private String file_name="GUI_test.txt";
	private String json_file_name="GUI_params.txt";
	@BeforeAll
	static void setUpBeforeClass() throws Exception {
		System.out.println("welcome to GUITest !");
	...
	void testFunctions_GUI() {
		assertTrue(_data instanceof Functions_GUI);
	}

	@Test
	void testInitFromFile() {
		assertDoesNotThrow(()->_data.initFromFile(file_name));
	}

	@Test
	void testSaveToFile() {
		assertDoesNotThrow(()->_data.saveToFile(file_name));
	}

	@Test
	void testDrawFunctions() {
		assertDoesNotThrow(()->_data.drawFunctions(600,600,new Range(-500, 500),new Range(-500, 500),600));
	}

	@Test
	void testDrawFunctionsIntIntRangeRangeInt() {
		assertDoesNotThrow(()->_data.drawFunctions(json_file_name));
	}
